...
import { encryptPrivatePayload, signData } from '../../cryptoUtils';
...
export default class UploadHandler extends BaseHandler {
    ...
    try {
        ...
        this.node.consensusEngine.handlePendingBlock(pendingBlock, { peerAddress: `127.0.0.1:${this.node.port}` } as PeerConnection, p2pMsg.header.timestamp.getTime()).catch(err => {
