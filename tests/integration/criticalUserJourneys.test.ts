...
import LocalFileStorageProvider from '../../storage_providers/localProvider/localProvider';
    ...
    it('Decrypts raw block payloads', async () => {
        try {
            ...
            for (let i = 0; i < 20; i++) {
                ...
                targetBlock = blockRes.blocks.find((b: any) => b.metadata && b.metadata.index > 0);
            ...
            const decryptedPayload = await decryptRes.json();
