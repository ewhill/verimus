...
import BaseProvider, { GetBlockReadStreamResult } from '../../storage_providers/baseProvider';
...
describe('Integration: Enterprise Stress Testing Core Pipelines (Phase 3)', () => {
    ...
    before(async () => {
        ...
        node = new PeerNode(32000, [], new NullStorageProvider(), new Bundler('dataLoad'), mongod.getUri(), undefined, {
        ...
        const setupExpressApp = (await import('../../apiServer')).default;
