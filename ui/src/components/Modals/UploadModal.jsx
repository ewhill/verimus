    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!currentPubKey) {
                ...
                currentPubKey = await getEncryptionPublicKey(web3Account, activeProvider);
            ...
            const signature = await signOriginatorProxyMessage(executionTime, 'batch', web3Account, activeProvider);
