...
const getBlockTypeConfig = (type) => {
    switch (type) {
        ...
        case 'VALIDATOR_REGISTRATION':
            return { icon: <svg fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>, color: '#9ca3af', bg: 'rgba(156, 163, 175, 0.15)', name: 'Validator' };
        default:
